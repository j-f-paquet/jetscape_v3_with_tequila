...
class TEQUILAUserInfo : public fjcore::PseudoJet::UserInfoBase {
private:
...
public:
  TEQUILAUserInfo() {}
  TEQUILAUserInfo(bool coherent, int sibling, FourVector pAtSplit)
...
class Tequila : public JetEnergyLossModule<
                    Tequila> //, public std::enable_shared_from_this<Tequila>
{
private:
  ...
  double Q0; // Separation scale between Matter and Tequila
  double alpha_s;
  double alpha_em;
  double g;
